    ...
    const StatisticsCardData = [
        ...
        },
        {
            ...
            icon: <PlugZap className='h-4 w-4' />,
            value: '42',
            title: 'Phase2 Voltage',
            changePercentage: '+18.2%'
        },
        {
            icon: <Activity className='h-4 w-4' />,
            value: '8',
            title: 'Phase2 Current',
            changePercentage: '-8.7'
        }, {
            
            icon: <PlugZap className='h-4 w-4' />,
            value: '42',
            title: 'Phase3 Voltage',
            changePercentage: '+18.2%'
        },
        {
            icon: <Activity className='h-4 w-4' />,
            value: '8',
            title: 'Phase3 Current',
            changePercentage: '-8.7'
        },
    {
            icon: <ThermometerIcon className='h-4 w-4' />,
            value: '27',
            title: 'Vfd Phase1 Temperature',
            changePercentage: '+4.3%',
        }, {
            icon: <ThermometerIcon className='h-4 w-4' />,
            value: '27',
            title: 'Vfd Phase2 Temperature',
            changePercentage: '+4.3%',
        },{
            icon: <ThermometerIcon className='h-4 w-4' />,
            value: '27',
    ...
    export function DashboardMain({data,loading,error}:DashboardDataProps) {
